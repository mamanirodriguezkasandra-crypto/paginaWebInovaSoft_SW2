    ...
    <div class="whole-wrap">
        <div class="container box_1170">
            <div class="section-top-border">
                <h3 class="mb-30">Visión</h3>
                <div class="row">
                    <div class="col-md-3">
                        <img src="img/elements/vision.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="col-md-9 mt-sm-20">
                        <p>Ser la empresa de desarrollo de software líder en el mercado,
                            proporcionando soluciones innovadoras y de alta calidad que ayuden a
                            nuestros clientes a alcanzar sus objetivos.</p>
                    </div>
                </div>
            </div>
            <div class="section-top-border text-right">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <img src="img/elements/mision.jpg" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
            <div class="section-top-border">
                <h3 class="mb-30">Valores</h3>
                <div class="row">
                    <div class="col-md-3">
